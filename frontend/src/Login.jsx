                ...
                <div className='w-6/12 h-3/4  shadow-lg'>
                    ...
                    <div className='w-full h-70p flex items-center flex-col'>
                        <div className='w-5/6 h-30p flex flex-col justify-around'>
                            ...
                            <input className='w-full h-50p text-2xl rounded-full border-2 border-gray-400 bg-gray-50 px-7' type="email" name="email" placeholder="Enter your email" required onChange={(e)=>setEmail(e.target.value)}></input>
                        </div>
                        <div className='w-5/6 h-30p flex flex-col justify-around'>
