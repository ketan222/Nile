...
function UserFooter() {
  ...
  return (
    <footer className="lg:h-20 md:h-16 sm:h-10 w-screen bg-secondary flex flex-row justify-between items-center text-textPrimary lg:text-lg md:text-base text-xs lg:px-16 sm:px-4">
      ...
      <div className="flex flex-row  justify-around items-center w-30p h-100p">
        <div>Follow us</div>
        <div className="flex flex-row justify-around items-center w-50p h-100p ">
          <Link to="/some-path" className=" rounded-full h-14 w-14">
            <svg
              ...
              height="100"
              viewBox="0 0 24 24"
              className="w-100p h-100p rounded-full"
            >
          ...
          <Link
            to="/some-path"
            className=" rounded-full h-14 w-14 flex justify-center items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
          ...
          <Link
            to="/some-path"
            className="flex justify-center items-center rounded-full h-14 w-14"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
